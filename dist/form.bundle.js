...
var initForm = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var params, response, user;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            params = new URL(location.href);
            userId = params.searchParams.get("_id");
            console.log(userId);
            ...
            _context.next = 6;
            return fetch("https://restapi.fr/api/user/".concat(userId));
...
var fillForm = function fillForm(user) {
...
form.addEventListener("submit", function (e) {
  ...
  var User = Object.fromEntries(data);
  console.log(User);
  var user = JSON.stringify(User);
  console.log(user);
  var Promess = fetch("https://restapi.fr/api/user", {
    method: "POST",
    body: user,
    headers: {
